...
class BenchmarkApp:
    def __init__(self, master):
        ...
        self.label = tk.Label(master, text="Run benchmark with 10000 entries?")
    ...
    def run_benchmark(self):
        ...
        summary = (
            ...
            f"Found in Search: BST: {results['Found In Search'][0]}, AVL: {results['Found In Search'][1]} out of 10000\n"
        )
